...
return [
    'packages' => [
        ...
        'ag_subscription' => [
            'composerName' => 'ag_subscription',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/ag_subscription/',
            'suggestions' => [],
        ],
        'gridelements' => [
        ...
        'office_ext' => [
            'composerName' => 'office_ext',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/office_ext/',
            'suggestions' => [],
        ],
        'powermail' => [
        ...
        'productfinder' => [
            'composerName' => 'productfinder',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/productfinder/',
            'suggestions' => [],
        ],
        'realurl' => [
        ...
        'website_template' => [
            'composerName' => 'website_template',
            'state' => 'active',
            'packagePath' => 'typo3conf/ext/website_template/',
            'suggestions' => [],
        ],
        'adodb' => [
