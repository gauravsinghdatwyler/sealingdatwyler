...
/**
 * Test case for class Datwyler\OfficeExt\Controller\QueryController.
 *
 */
class QueryControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \Datwyler\OfficeExt\Controller\QueryController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('Datwyler\\OfficeExt\\Controller\\QueryController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllQueriesFromRepositoryAndAssignsThemToView()
	{
		...
		$queryRepository = $this->getMock('Datwyler\\OfficeExt\\Domain\\Repository\\QueryRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$query = new \Datwyler\OfficeExt\Domain\Model\Query();
	...
	public function createActionAddsTheGivenQueryToQueryRepository()
	{
		...
		$queryRepository = $this->getMock('Datwyler\\OfficeExt\\Domain\\Repository\\QueryRepository', array('add'), array(), '', FALSE);
	...
	public function updateActionUpdatesTheGivenQueryInQueryRepository()
	{
		...
		$queryRepository = $this->getMock('Datwyler\\OfficeExt\\Domain\\Repository\\QueryRepository', array('update'), array(), '', FALSE);
	...
	public function deleteActionRemovesTheGivenQueryFromQueryRepository()
	{
		...
		$queryRepository = $this->getMock('Datwyler\\OfficeExt\\Domain\\Repository\\QueryRepository', array('remove'), array(), '', FALSE);
