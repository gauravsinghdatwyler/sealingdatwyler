...
/**
 * Test case for class \Datwyler\OfficeExt\Domain\Model\Awards.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class AwardsTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	/**
	 * @var \Datwyler\OfficeExt\Domain\Model\Awards
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = new \Datwyler\OfficeExt\Domain\Model\Awards();
	}
