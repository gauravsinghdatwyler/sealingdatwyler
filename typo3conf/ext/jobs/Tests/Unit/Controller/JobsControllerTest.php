<?php
namespace TYPO3\Jobs\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
 *  (c) 2016 
...
/**
 * Test case for class TYPO3\Jobs\Controller\JobsController.
 *
 */
class JobsControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \TYPO3\Jobs\Controller\JobsController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('TYPO3\\Jobs\\Controller\\JobsController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllJobssFromRepositoryAndAssignsThemToView()
	{
		...
		$jobsRepository = $this->getMock('TYPO3\\Jobs\\Domain\\Repository\\JobsRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$jobs = new \TYPO3\Jobs\Domain\Model\Jobs();
