<?php
namespace TYPO3\Productfinder\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
 *  (c) 2016 
...
/**
 * Test case for class TYPO3\Productfinder\Controller\ProductsController.
 *
 */
class ProductsControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \TYPO3\Productfinder\Controller\ProductsController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('TYPO3\\Productfinder\\Controller\\ProductsController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllProductssFromRepositoryAndAssignsThemToView()
	{
		...
		$productsRepository = $this->getMock('TYPO3\\Productfinder\\Domain\\Repository\\ProductsRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$products = new \TYPO3\Productfinder\Domain\Model\Products();
