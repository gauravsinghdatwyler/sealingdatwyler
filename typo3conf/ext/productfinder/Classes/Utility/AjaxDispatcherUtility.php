<?php
namespace TYPO3\Productfinder\Utility;
...
class AjaxDispatcherUtility
{
    ...
    public function __construct($TYPO3_CONF_VARS)
    {
        ...
        $pluginConfiguration = $TypoScriptService->convertTypoScriptArrayToPlainArray($GLOBALS['TSFE']->tmpl->setup['plugin.']['tx_productfinder_pi1.']);

        $this->configuration = [
            'pluginName' => 'Pi1',
            'vendorName' => 'TYPO3',
            'extensionName' => 'Productfinder',
            'controller' => 'Products',
            'action' => 'searchAjax',
            'mvc' => [
                'requestHandlers' => [
...
$eid = GeneralUtility::makeInstance('TYPO3\\Productfinder\\Utility\\AjaxDispatcherUtility', $GLOBALS['TYPO3_CONF_VARS']);
echo $eid->run();
