webshims.register('form-number-date-api', function($, webshims, window, doc, undefined, options){
	"use strict";
	...
	var runTest = false;
	var validityRules = {};
	var updateValidity = (function(){alert("test1");
		var timer;
	...
	$.each({typeMismatch: 'mismatch', badInput: 'bad'}, function(name, fn){alert("test2");
	...
	var testValidity = function(elem, init){alert("test3");
	...
	['input', 'textarea', 'select'].forEach(function(name){alert("test4");
...
;webshims.register('form-number-date-api', function($, webshims, window, document, undefined, options){alert("test5");
	"use strict";
	...
	if(!webshims.getStep){alert("test6");
