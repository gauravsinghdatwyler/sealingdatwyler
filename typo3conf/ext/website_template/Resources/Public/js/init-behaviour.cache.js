...
//      ,paginationAtoms: '<li class="pa-$number" title="$title"><a href="#">$number</a></li>'
    ...
    /*
    $('#main div.teaser-wrapper.tw-paging').not('.content-slider')
      .append('<div class="pager"><div class="nav-arrow prev" style="opacity: 0;">O</div><div class="nav-arrow next">J</div></div>')
      .scroller({
      pagination: 'div.pagination',
      prevLink: '.nav-arrow.prev',
      nextLink: '.nav-arrow.next',
      pagination: 'div.pagination',
      paginationFn: myPag,
      linkFn: myLink,
      paginationTitleFrom: 'h2'
//      ,paginationAtoms: '<li class="pa-$number" title="$title"><a href="#">$number</a></li>'
    ...
    */
    ...
    var $contentSlider = $('header').find('.content-slider');
    var $employeeSlider = $('<div class="teaser-wrapper teaser-wrapper-paging content-slider tw-paging">').append($contentSlider.find('.rack')).append('<div class="pagination"></div>');
    $contentSlider.remove();
    $employeeSlider.wrap('<div class="content-slider-container"></div>').insertAfter('header');
    
     $('div.teaser-wrapper.tw-paging').append('<div class="pager"><div class="nav-arrow prev" style="opacity: 0;">&#x4f;</div><div class="nav-arrow next">&#x4a;</div></div>')
      .scroller({
      pagination: 'div.pagination',
      prevLink: '.nav-arrow.prev',
      nextLink: '.nav-arrow.next',
...
//      ,paginationAtoms: '<li class="pa-$number" title="$title"><a href="#">$number</a></li>'
    ...
    /*
    var $contentSlider = $('header').find('.content-slider');
    var $employeeSlider = $('<div class="teaser-wrapper teaser-wrapper-paging content-slider tw-paging">').append($contentSlider.find('.rack'));
    $contentSlider.remove();
    $employeeSlider
      .insertAfter('header')
      .append('<div class="pager"><div class="nav-arrow prev" style="opacity: 0;">O</div><div class="nav-arrow next">J</div></div>')
