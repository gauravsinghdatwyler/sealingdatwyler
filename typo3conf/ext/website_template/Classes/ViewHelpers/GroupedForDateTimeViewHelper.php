 ...
 * @api
 */
class Tx_NewsGroupedByDate_ViewHelpers_GroupedForDateTimeViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper {
    ...
    protected function groupElements(array $elements, $groupBy, $format) {
        ...
        foreach ($elements as $key => $value) {
            if (is_array($value)) {
                ...
                throw new \TYPO3\CMS\Fluid\Core\ViewHelper\Exceptionn('GroupedForViewHelper only supports multi-dimensional arrays and objects' , 1253120365);
            }
